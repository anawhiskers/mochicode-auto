...
function Set-MochiCodeMarkerBlock {
    ...
    $block = @(
        ...
        '- Keep verified state only for interruption-prone work. Candidate lessons are never injected; activate a lesson only after positive recurrence and a successful negative-control task.'
